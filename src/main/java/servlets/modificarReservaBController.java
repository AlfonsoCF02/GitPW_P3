 ...
 */
public class modificarReservaBController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public modificarReservaBController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("mvc/view/modificarReservaBView.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			int res = gr.ModificarReservaIndividual(idres, b,nbono, email, horares, fechares, duracion, pista, nninios, nadultos);
			
			request.setAttribute("res", res);
			request.getRequestDispatcher("comprobarModRB.jsp").forward(request, response);
