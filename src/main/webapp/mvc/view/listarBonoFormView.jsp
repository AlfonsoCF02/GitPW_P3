...
<head>
	<meta charset="UTF-8">
	<title>bono formulario listar</title>
...
if (customerBean != null && !customerBean.getEmail().equals("") && (customerBean.getPrivilegios().toString().equals("user"))) {%>
	<div id=div_form_listarBono>	
		<form id="formbono" method="post" action="${pageContext.request.contextPath}/listarbono">
			<label for="tipo">
				<span>Dificultad(tipo):</span>
			</label>
		    ...
		    <input type="hidden" name="email" value=<%=customerBean.getEmail()%>><br><br>
